...
class NowPlayingAdapter :
    PagedListAdapter<NowPlayingEntity, NowPlayingAdapter.ViewHolder>(DiffCallback) {

    companion object {
        val DiffCallback = object : DiffUtil.ItemCallback<NowPlayingEntity>() {
    ...
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bindItems(movie: NowPlayingEntity) {
