...
class TopRatedAdapter : PagedListAdapter<TopRatedEntity, TopRatedAdapter.ViewHolder>(DiffCallback) {

    companion object {
        val DiffCallback = object : DiffUtil.ItemCallback<TopRatedEntity>() {
            override fun areItemsTheSame(
                oldItem: TopRatedEntity,
                newItem: TopRatedEntity
            ): Boolean {
    ...
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bindItems(movie: TopRatedEntity) {
